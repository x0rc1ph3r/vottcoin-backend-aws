import { h as N, j as R } from "./index-C8aEsj0u.js";
var h = { exports: {} }, a = typeof Reflect == "object" ? Reflect : null, m = a && typeof a.apply == "function" ? a.apply : function(e, n, r) {
...
o.prototype.emit = function(e) {
  ...
  if (typeof c == "function")
    ...
    for (var d = c.length, j = E(c, d), r = 0; r < d; ++r)
      m(j[r], this, n);
  return !0;
};
function g(t, e, n, r) {
  var i, f, s;
  if (p(n), f = t._events, f === void 0 ? (f = t._events = /* @__PURE__ */ Object.create(null), t._eventsCount = 0) : (f.newListener !== void 0 && (t.emit(
    "newListener",
    e,
    n.listener ? n.listener : n
  ), f = t._events), s = f[e]), s === void 0)
    s = f[e] = n, ++t._eventsCount;
  else if (typeof s == "function" ? s = f[e] = r ? [n, s] : [s, n] : r ? s.unshift(n) : s.push(n), i = _(t), i > 0 && s.length > i && !s.warned) {
    s.warned = !0;
    var u = new Error("Possible EventEmitter memory leak detected. " + s.length + " " + String(e) + " listeners added. Use emitter.setMaxListeners() to increase limit");
    u.name = "MaxListenersExceededWarning", u.emitter = t, u.type = e, u.count = s.length, M(u);
  }
  return t;
}
...
function b(t, e, n) {
  var r = { fired: !1, wrapFn: void 0, target: t, type: e, listener: n }, i = A.bind(r);
  return i.listener = n, r.wrapFn = i, i;
}
o.prototype.once = function(e, n) {
  return p(n), this.on(e, b(this, e, n)), this;
};
o.prototype.prependOnceListener = function(e, n) {
  return p(n), this.prependListener(e, b(this, e, n)), this;
};
o.prototype.removeListener = function(e, n) {
  ...
  if (r === n || r.listener === n)
    ...
    if (f < 0)
      return this;
    f === 0 ? r.shift() : C(r, f), r.length === 1 && (i[e] = r[0]), i.removeListener !== void 0 && this.emit("removeListener", e, u || n);
  }
  return this;
};
...
function w(t, e, n) {
  ...
  if (r === void 0)
    return [];
  var i = r[e];
  return i === void 0 ? [] : typeof i == "function" ? n ? [i.listener || i] : [i] : n ? P(i) : E(i, i.length);
}
...
function T(t, e) {
  return new Promise(function(n, r) {
    ...
    O(t, e, f, { once: !0 }), e !== "error" && F(t, i, { once: !0 });
  });
}
function F(t, e, n) {
...
var I = h.exports;
const $ = /* @__PURE__ */ N(I), K = {}, S = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: K
}, Symbol.toStringTag, { value: "Module" })), B = /* @__PURE__ */ R(S);
var v = { exports: {} };
typeof Object.create == "function" ? v.exports = function(e, n) {
